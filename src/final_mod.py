...
ax.text(0.15, 0.65, " ".join(["AUC:",str(auc_final.round(3))]), fontsize=20, color = 'b')
ax.text(0.15, 0.6, " ".join(['AUC:',str(auc_train.round(3))]), fontsize=20, color = 'r')
...
ax.text(0.15, 0.65, " ".join(["AUC:",str(auc_final_holdout.round(3))]), fontsize=20, color = 'b')
ax.text(0.15, 0.6, " ".join(['AUC:',str(auc_train_holdout.round(3))]), fontsize=20, color = 'r')
ax.legend(fontsize=24)
...
plt.title("Proportional Percent of Categorical Parameters in Training Data", fontsize = 18)
plt.ylim=1.0
